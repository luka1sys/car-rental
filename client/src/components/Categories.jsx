        ...
        <section className='min-h-[300px] sm:min-h-[400px] md:min-h-[450px] w-full max-w-[97%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-[10px] px-4 sm:px-6 md:px-8'>
            <div className='group rounded-[30px] sm:rounded-[40px] overflow-hidden cursor-pointer relative bg-[url(/luxury-collection-img-1.jpg)] bg-center bg-cover transition-[background-size] duration-[800ms] ease-in-out hover:bg-[length:115%_115%] dvv1 animate-on-scroll min-h-[250px] sm:min-h-[300px] md:min-h-[350px] lg:h-[450px]'>
                <div className='bg-black/30 w-full h-full'>
                    ...
                    <button className="absolute bottom-6 sm:bottom-8 md:bottom-[40px] right-6 sm:right-8 md:right-[40px] bg-[rgb(255,54,0)] mt-[2px] w-[45px] h-[45px] sm:w-[50px] sm:h-[50px] md:w-[55px] md:h-[55px] rounded-full group-hover:bg-black cursor-pointer transform rotate-[-45deg] pl-[10px] sm:pl-[12px] md:pl-[13px] group-hover:rotate-[0deg] transition-all duration-[500ms] flex items-center justify-center">
            ...
            <div className='group rounded-[30px] sm:rounded-[40px] overflow-hidden cursor-pointer relative bg-[url(/luxury-collection-img-3.webp)] bg-center bg-cover transition-[background-size] duration-[800ms] ease-in-out hover:bg-[length:115%_115%] dvv3 animate-on-scroll min-h-[250px] sm:min-h-[300px] md:min-h-[350px] lg:h-[450px]'>
                <div className='bg-black/30 w-full h-full'>
                    <p className='absolute top-6 sm:top-8 md:top-[30px] text-white text-2xl sm:text-3xl md:text-[35px] font-semibold left-6 sm:left-8 md:left-[40px]'>
                        Sedan Car
                    </p>
            ...
            <div className='group rounded-[30px] sm:rounded-[40px] overflow-hidden cursor-pointer relative bg-[url(/luxury-collection-img-4.webp)] bg-center bg-cover transition-[background-size] duration-[800ms] ease-in-out hover:bg-[length:115%_115%] dvv4 animate-on-scroll min-h-[250px] sm:min-h-[300px] md:min-h-[350px] lg:h-[450px]'>
                <div className='bg-black/30 w-full h-full'>
                    <p className='absolute top-6 sm:top-8 md:top-[30px] text-white text-2xl sm:text-3xl md:text-[35px] font-semibold left-6 sm:left-8 md:left-[40px]'>
                        Luxury car
                    </p>
